...
export const UNITS: UnitDefinition[] = [
  // LENGTH
  { id: 'mm', slug: 'millimeters', symbol: 'mm', names: { en: 'Millimeters', it: 'Millimetri' }, category: 'length' },
  { id: 'cm', slug: 'centimeters', symbol: 'cm', names: { en: 'Centimeters', it: 'Centimetri' }, category: 'length' },
  { id: 'm', slug: 'meters', symbol: 'm', names: { en: 'Meters', it: 'Metri' }, category: 'length' },
  { id: 'km', slug: 'kilometers', symbol: 'km', names: { en: 'Kilometers', it: 'Chilometri' }, category: 'length' },
  { id: 'in', slug: 'inches', symbol: 'in', names: { en: 'Inches', it: 'Pollici' }, category: 'length' },
  { id: 'ft', slug: 'feet', symbol: 'ft', names: { en: 'Feet', it: 'Piedi' }, category: 'length' },
  { id: 'yd', slug: 'yards', symbol: 'yd', names: { en: 'Yards', it: 'Iarde' }, category: 'length' },
  { id: 'mi', slug: 'miles', symbol: 'mi', names: { en: 'Miles', it: 'Miglia' }, category: 'length' },

  // WEIGHT
  { id: 'mg', slug: 'milligrams', symbol: 'mg', names: { en: 'Milligrams', it: 'Milligrammi' }, category: 'weight' },
  { id: 'g', slug: 'grams', symbol: 'g', names: { en: 'Grams', it: 'Grammi' }, category: 'weight' },
  { id: 'kg', slug: 'kilograms', symbol: 'kg', names: { en: 'Kilograms', it: 'Chilogrammi' }, category: 'weight' },
  { id: 'ton', slug: 'metric-tons', symbol: 't', names: { en: 'Metric Tons', it: 'Tonnellate' }, category: 'weight' },
  { id: 'oz', slug: 'ounces', symbol: 'oz', names: { en: 'Ounces', it: 'Once' }, category: 'weight' },
  { id: 'lb', slug: 'pounds', symbol: 'lb', names: { en: 'Pounds', it: 'Libbre' }, category: 'weight' },
  { id: 'st', slug: 'stones', symbol: 'st', names: { en: 'Stones', it: 'Stones' }, category: 'weight' },

  // VOLUME
  { id: 'ml', slug: 'milliliters', symbol: 'ml', names: { en: 'Milliliters', it: 'Millilitri' }, category: 'volume' },
  { id: 'l', slug: 'liters', symbol: 'L', names: { en: 'Liters', it: 'Litri' }, category: 'volume' },
  { id: 'gal', slug: 'gallons', symbol: 'gal', names: { en: 'Gallons (US)', it: 'Galloni (US)' }, category: 'volume' },
  { id: 'qt', slug: 'quarts', symbol: 'qt', names: { en: 'Quarts', it: 'Quarti' }, category: 'volume' },
  { id: 'pt', slug: 'pints', symbol: 'pt', names: { en: 'Pints', it: 'Pinte' }, category: 'volume' },
  { id: 'floz', slug: 'fluid-ounces', symbol: 'fl oz', names: { en: 'Fluid Ounces', it: 'Once liquide' }, category: 'volume' },

  // TEMPERATURE
  { id: 'c', slug: 'celsius', symbol: '°C', names: { en: 'Celsius', it: 'Celsius' }, category: 'temperature' },
  { id: 'f', slug: 'fahrenheit', symbol: '°F', names: { en: 'Fahrenheit', it: 'Fahrenheit' }, category: 'temperature' },
  { id: 'k', slug: 'kelvin', symbol: 'K', names: { en: 'Kelvin', it: 'Kelvin' }, category: 'temperature' },

  // ENERGY
  { id: 'j', slug: 'joules', symbol: 'J', names: { en: 'Joules', it: 'Joule' }, category: 'energy' },
  { id: 'kj', slug: 'kilojoules', symbol: 'kJ', names: { en: 'Kilojoules', it: 'Kilojoule' }, category: 'energy' },
  { id: 'cal', slug: 'calories', symbol: 'cal', names: { en: 'Calories', it: 'Calorie' }, category: 'energy' },
  { id: 'kcal', slug: 'kilocalories', symbol: 'kcal', names: { en: 'Kilocalories', it: 'Kilocalorie' }, category: 'energy' },
  { id: 'kwh', slug: 'kilowatt-hours', symbol: 'kWh', names: { en: 'Kilowatt-hours', it: 'Kilowattora' }, category: 'energy' },
  { id: 'btu', slug: 'btu', symbol: 'BTU', names: { en: 'BTU', it: 'BTU' }, category: 'energy' },

  // POWER
  { id: 'w', slug: 'watts', symbol: 'W', names: { en: 'Watts', it: 'Watt' }, category: 'power' },
  { id: 'kw', slug: 'kilowatts', symbol: 'kW', names: { en: 'Kilowatts', it: 'Kilowatt' }, category: 'power' },
  { id: 'hp', slug: 'horsepower', symbol: 'hp', names: { en: 'Horsepower', it: 'Cavalli vapore' }, category: 'power' },
  { id: 'btuh', slug: 'btu-per-hour', symbol: 'BTU/h', names: { en: 'BTU/hour', it: 'BTU/ora' }, category: 'power' },

  // AREA
  { id: 'sqm', slug: 'square-meters', symbol: 'm²', names: { en: 'Square Meters', it: 'Metri quadrati' }, category: 'area' },
  { id: 'sqft', slug: 'square-feet', symbol: 'ft²', names: { en: 'Square Feet', it: 'Piedi quadrati' }, category: 'area' },
  { id: 'sqkm', slug: 'square-kilometers', symbol: 'km²', names: { en: 'Square Kilometers', it: 'Chilometri quadrati' }, category: 'area' },
  { id: 'sqmi', slug: 'square-miles', symbol: 'mi²', names: { en: 'Square Miles', it: 'Miglia quadrate' }, category: 'area' },
  { id: 'ha', slug: 'hectares', symbol: 'ha', names: { en: 'Hectares', it: 'Ettari' }, category: 'area' },
  { id: 'ac', slug: 'acres', symbol: 'ac', names: { en: 'Acres', it: 'Acri' }, category: 'area' },

  // SPEED
  { id: 'kmh', slug: 'km-per-hour', symbol: 'km/h', names: { en: 'km/h', it: 'km/h' }, category: 'speed' },
  { id: 'mph', slug: 'miles-per-hour', symbol: 'mph', names: { en: 'mph', it: 'mph' }, category: 'speed' },
  { id: 'ms', slug: 'meters-per-second', symbol: 'm/s', names: { en: 'm/s', it: 'm/s' }, category: 'speed' },
  { id: 'kn', slug: 'knots', symbol: 'kn', names: { en: 'Knots', it: 'Nodi' }, category: 'speed' },

  // PRESSURE
  { id: 'pa', slug: 'pascals', symbol: 'Pa', names: { en: 'Pascals', it: 'Pascal' }, category: 'pressure' },
  { id: 'bar', slug: 'bar', symbol: 'bar', names: { en: 'Bar', it: 'Bar' }, category: 'pressure' },
  { id: 'psi', slug: 'psi', symbol: 'psi', names: { en: 'PSI', it: 'PSI' }, category: 'pressure' },
  { id: 'atm', slug: 'atmospheres', symbol: 'atm', names: { en: 'Atmospheres', it: 'Atmosfere' }, category: 'pressure' },

  // DATA
  { id: 'b', slug: 'bytes', symbol: 'B', names: { en: 'Bytes', it: 'Byte' }, category: 'data' },
  { id: 'kb', slug: 'kilobytes', symbol: 'KB', names: { en: 'Kilobytes', it: 'Kilobyte' }, category: 'data' },
  { id: 'mb', slug: 'megabytes', symbol: 'MB', names: { en: 'Megabytes', it: 'Megabyte' }, category: 'data' },
  { id: 'gb', slug: 'gigabytes', symbol: 'GB', names: { en: 'Gigabytes', it: 'Gigabyte' }, category: 'data' },
  { id: 'tb', slug: 'terabytes', symbol: 'TB', names: { en: 'Terabytes', it: 'Terabyte' }, category: 'data' },
]
...
export const CATEGORY_NAMES: Record<ConversionCategory, Record<Locale, string>> = {
  length: { en: 'Length', it: 'Lunghezza' },
  weight: { en: 'Weight & Mass', it: 'Peso e Massa' },
  volume: { en: 'Volume', it: 'Volume' },
  temperature: { en: 'Temperature', it: 'Temperatura' },
  energy: { en: 'Energy', it: 'Energia' },
  power: { en: 'Power', it: 'Potenza' },
  area: { en: 'Area', it: 'Superficie' },
  speed: { en: 'Speed', it: 'Velocità' },
  pressure: { en: 'Pressure', it: 'Pressione' },
  data: { en: 'Data Storage', it: 'Archiviazione Dati' },
}
